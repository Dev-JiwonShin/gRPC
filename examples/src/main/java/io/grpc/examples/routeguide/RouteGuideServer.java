...
public class RouteGuideServer {
    ...
    private static class RouteGuideService extends RouteGuideGrpc.RouteGuideImplBase {
        ...
        /**
         Gets the {@link Feature} at the requested {@link Point}. If no feature at that location exists, an unnamed
         feature is returned at the provided location.
        ...
        public void listFeatures (Rectangle request, StreamObserver<Feature> responseObserver) {
            ...
            info("Server processing gRPC server-streaming");
        ...
        /**
         Gets a stream of points, and responds with statistics about the "trip": number of points, number of known
         features visited, total distance traveled, and total time spent.
        ...
        public StreamObserver<Point> recordRoute (final StreamObserver<RouteSummary> responseObserver) {
            info("Server processing gRPC client-streaming");
            return new StreamObserver<Point>() {
                ...
                public void onCompleted () {
                    ...
                    responseObserver.onNext(RouteSummary.newBuilder().setPointCount(pointCount).setFeatureCount(featureCount).setDistance(distance).setElapsedTime((int) seconds).build());
                    responseObserver.onCompleted();
                }
            };
        }
        ...
        /**
         Receives a stream of message/location pairs, and responds with a stream of all previous messages at each of
         those locations.
        ...
        public StreamObserver<RouteNote> routeChat (final StreamObserver<RouteNote> responseObserver) {
            return new StreamObserver<RouteNote>() {
                ...
                public void onCompleted () {
                    responseObserver.onCompleted();
                    info("Server processing gRPC bidirectional streaming " );
                    cnt=1;
                }
            };
        }
